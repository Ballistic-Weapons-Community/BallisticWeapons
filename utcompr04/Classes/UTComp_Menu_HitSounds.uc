...
function DisableStuff()
{
	...
	if(!ch_EnableHitSounds.IsChecked() || (UTCompSRI != None && UTCompSRI.EnableHitSoundsMode==0))
	{
		sl_volume.DisableMe();
		sl_Pitch.DisableMe();
...
function InternalOnChange( GUIComponent C )
{
	switch(C)
	{
		case ch_EnableHitSounds: 
			class'UTComp_Settings'.default.bEnableHitSounds=ch_enableHitSounds.IsChecked(); 
			break;
			
		case sl_Volume:
			class'UTComp_Settings'.default.HitSoundVolume=sl_Volume.Value;
			break;
			
		case sl_Pitch:
			class'UTComp_Settings'.default.CPMAPitchModifier=sl_Pitch.Value;
			break;
		...
		case ch_CPMAStyle:
			class'UTComp_Settings'.default.bCPMAStyleHitSounds=ch_CPMAStyle.IsChecked();
			break;
	}
...
defaultproperties
{
     ...
     End Object
     sl_Volume=GUISlider'utcompr04.UTComp_Menu_HitSounds.HitSoundVolume'
     ...
     End Object
     sl_Pitch=GUISlider'utcompr04.UTComp_Menu_HitSounds.PitchMod'
     ...
     Begin Object Class=moCheckBox Name=CPMAstyle
         ...
         OnChange=UTComp_Menu_HitSounds.InternalOnChange
     End Object
     ch_CPMAStyle=moCheckBox'utcompr04.UTComp_Menu_HitSounds.CPMAstyle'
     ...
     Begin Object Class=moCheckBox Name=EnableHit
         ...
         OnChange=UTComp_Menu_HitSounds.InternalOnChange
     End Object
     ch_EnableHitSounds=moCheckBox'utcompr04.UTComp_Menu_HitSounds.EnableHit'
     ...
     End Object
     co_EnemySound=GUIComboBox'utcompr04.UTComp_Menu_HitSounds.EnemySound'
     ...
     Begin Object Class=GUIComboBox Name=TeammateSound
         ...
         OnKeyEvent=UTComp_Menu_HitSounds.InternalOnKeyEvent
     End Object
     co_FriendlySound=GUIComboBox'utcompr04.UTComp_Menu_HitSounds.TeammateSound'
     ...
     Begin Object Class=GUILabel Name=VolumeLabel
         ...
         WinLeft=0.250000
     End Object
     l_Volume=GUILabel'utcompr04.UTComp_Menu_HitSounds.VolumeLabel'
     ...
     Begin Object Class=GUILabel Name=PitchLabel
         ...
         WinLeft=0.250000
     End Object
     l_Pitch=GUILabel'utcompr04.UTComp_Menu_HitSounds.PitchLabel'
     ...
     Begin Object Class=GUILabel Name=EnemySoundLabel
         ...
         WinLeft=0.250000
     End Object
     l_EnemySound=GUILabel'utcompr04.UTComp_Menu_HitSounds.EnemySoundLabel'
     ...
     Begin Object Class=GUILabel Name=FriendlySoundLabel
         ...
         WinLeft=0.250000
     End Object
     l_FriendlySound=GUILabel'utcompr04.UTComp_Menu_HitSounds.FriendlySoundLabel'
