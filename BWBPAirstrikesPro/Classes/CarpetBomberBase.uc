class CarpetBomberBase extends Actor;
...
function Timer()
{
	...
	if (VSize(Location - BombTargetCenter) < BombRange)
	{
		...
		Carpetbomberbomb(myBomb).Velocity+=NewVelocity;//0.75*Velocity;
...
defaultproperties
{
     BombOffset=(Y=250.000000)
     Speed=10000.000000
     MinSpeed=2000.000000
     BombRange=7500.000000
     BombClass=Class'BWBPAirstrikesPro.CarpetBomberBomb'
     Health=1500
     Team=255
     Damage=250.000000
