class X93PainterBeamEffect extends xEmitter;
...
var enum EX93PainterTargetingState
{
    PTS_Aiming,
    PTS_Marked,
    PTS_Aquired,
...
function SetTargetState(EX93PainterTargetingState NewState)
{
...
simulated function Tick(float dt)
{
    ...
    else
    {
        if ( Instigator.IsFirstPerson() && Instigator.Weapon != None )
        {
            ...
            EndEffect = X93Painter(Instigator.Weapon).EndEffect;
        }
        else
        {
...
state Aquired
{
    ...
    simulated function SetTargetState(EX93PainterTargetingState NewState)
    {
    }
}
