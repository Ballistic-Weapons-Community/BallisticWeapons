...
//
//-----------------------------------------------------------
class CBU78BaseShell extends AirstrikeProjectile;
...
simulated function Timer()
{
    ...
    for (i=0; i<60; i++)
    {
        SmallShell = spawn(class'CBU78Mine', self, , Location, Rotation);
		if ( SmallShell != None )
...
{
	if (Other != Instigator && !Other.IsA('CBU78BaseShell'))
	{
