class AIM9RocketMissile extends AirstrikeProjectile;
...
simulated function Destroyed()
{
	...
	if (!bNoFX && EffectIsRelevant(Location, false))
		spawn(class'ONSVehicleExplosionEffect',,, Location, rotator(vect(0,0,1)));
...
simulated function PostBeginPlay()
{
	...
	{
		SmokeTrail = Spawn(class'AIM9MissileTrail',,,Location - 15 * Dir);
