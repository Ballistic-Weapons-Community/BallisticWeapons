class X93PainterPickup extends UTWeaponPickup;
...
defaultproperties
{
     ...
     InventoryType=Class'BWBPAirstrikesPro.X93Painter'
     RespawnTime=360.000000
     PickupMessage="You got the X-93A Orbital Weapon Designator."
