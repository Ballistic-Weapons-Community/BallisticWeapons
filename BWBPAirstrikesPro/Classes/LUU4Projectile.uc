...
// rocket.
//=============================================================================
class LUU4Projectile extends AirstrikeProjectile;

var	W54SmokeTrail SmokeTrail;
...
simulated function PostBeginPlay()
{
	...
	{
		SmokeTrail = Spawn(class'W54SmokeTrail',self,,Location - 40 * Dir, Rotation);
...
Begin:
    ...
    Sleep(0.5);
    HurtRadius(Damage*0.5, DamageRadius*1.000, MyDamageType, MomentumTransfer, Location);
    Sleep(0.5);
    HurtRadius(Damage*0.25, DamageRadius*1.000, MyDamageType, MomentumTransfer, Location);
    Sleep(0.5);
    HurtRadius(Damage*0.01, DamageRadius*1.000, MyDamageType, MomentumTransfer, Location);
    Sleep(0.5);
    HurtRadius(Damage*0.01, DamageRadius*1.000, MyDamageType, MomentumTransfer, Location);
    Sleep(0.5);
    HurtRadius(Damage*0.01, DamageRadius*1.000, MyDamageType, MomentumTransfer, Location);
...
defaultproperties
{
     ...
     ExplosionEffectClass=Class'BWBPAirstrikesPro.LUU4explosion'
     Team=255
     Speed=100.000000
     MaxSpeed=150.000000
