...
//
//-----------------------------------------------------------
class CBU30Projectile extends AirstrikeProjectile;
...
state Dying
{
    ...
    function BeginState()
    {
		...
		Spawn(class'FlakExplosion',,, Location, Rotation);
		ShakeView();
		InitialState = 'Dying';
		SetTimer(0.5, true);
...
defaultproperties
{
     ...
     ExplosionEffectClass=Class'BWBPAirstrikesPro.CBU30Explosion'
     Speed=10000.000000
