...
//=============================================================================
class M807Pistol extends BallisticHandgun;
...
{
	if (M807Pistol(OtherGun) == None && Mode != 0)
		return false;
	else if(M807Pistol(OtherGun) != None)
		return true;
...
defaultproperties
{
	...
	SightFXClass=Class'BallisticDE.M806SightLEDs'
	...
	ParamsClasses(0)=Class'M807WeaponParams'
	ParamsClasses(1)=Class'M807WeaponParams'
	ParamsClasses(2)=Class'M807WeaponParams'
	FireModeClass(0)=Class'BWBP_KFC_DE.M807PrimaryFire'
	FireModeClass(1)=Class'BWBP_KFC_DE.M807SecondaryFire'
	MeleeFireClass=Class'BallisticDE.M806MeleeFire'
