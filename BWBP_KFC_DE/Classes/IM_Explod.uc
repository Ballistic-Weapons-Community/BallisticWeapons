...
// IfAEF.
//
// IExplod to smitheroons
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2005 RuneStorm. All Rights Reserved.
//=============================================================================
class IM_Explod extends BCImpactManager;
...
defaultproperties
{
     ...
     HitEffects(0)=Class'BallisticDE.IE_RocketExplosion'
     HitDecals(0)=Class'BallisticDE.AD_Explosion'
     HitSounds(0)=Sound'PackageSounds4F.FART.FAR-Explod'
