...
//=============================================================================
class MagicFingerSoul extends BallisticGrenade;
...
defaultproperties
{
	ModeIndex=1
     ...
     ImpactDamage=120
     ImpactManager=Class'BWBP_KFC_DE.IM_Explod'
     TrailClass=Class'BallisticDE.M50GrenadeTrail'
     TrailOffset=(X=-8.000000)
     MyRadiusDamageType=Class'BWBP_KFC_DE.DTMagicFingerHit'
     SplashManager=Class'BWBP_KFC_DE.IM_Explod'
     ShakeRadius=20048.000000
     ...
     MyDamageType=Class'BWBP_KFC_DE.DTMagicFingerHit'
     LightType=LT_Steady
