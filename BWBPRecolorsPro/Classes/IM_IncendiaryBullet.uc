...
defaultproperties
{
     HitEffects(0)=Class'BWBPRecolorsPro.IE_IncBulletDirt'
     HitEffects(1)=Class'BWBPRecolorsPro.IE_IncBulletDirt'
     HitEffects(2)=Class'BWBPRecolorsPro.IE_IncBulletDirt'
     HitEffects(3)=Class'BWBPRecolorsPro.IE_IncBulletDirt'
