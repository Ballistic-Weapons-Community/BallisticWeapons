...
defaultproperties
{
     ...
     HitSounds(0)=Sound'PackageSounds4ProExp.VSK.VSK-Impact'
     HitSounds(1)=Sound'PackageSounds4ProExp.VSK.VSK-Impact'
     HitSounds(2)=Sound'PackageSounds4ProExp.VSK.VSK-Impact'
     HitSounds(3)=Sound'PackageSounds4ProExp.VSK.VSK-Impact'
     HitSounds(4)=Sound'PackageSounds4ProExp.VSK.VSK-Impact'
     HitSounds(5)=Sound'PackageSounds4ProExp.VSK.VSK-Impact'
     HitSounds(6)=Sound'PackageSounds4ProExp.VSK.VSK-Impact'
     HitSounds(7)=Sound'PackageSounds4ProExp.VSK.VSK-Impact'
     HitSounds(8)=Sound'PackageSounds4ProExp.VSK.VSK-Impact'
     HitSounds(9)=SoundGroup'BallisticSounds2.BulletImpacts.BulletWater'
     HitSounds(10)=Sound'PackageSounds4ProExp.VSK.VSK-Impact'
