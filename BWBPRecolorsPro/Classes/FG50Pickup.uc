...
{
	L.AddPrecacheMaterial(Texture'BWBP_SKC_TexExp.FG50.FG50-Main');
	L.AddPrecacheMaterial(Texture'BWBP_SKC_TexExp.FG50.FG50-Misc');
	L.AddPrecacheMaterial(Texture'BWBP_SKC_TexExp.FG50.FG50-Screen');
	L.AddPrecacheMaterial(Texture'BWBP_SKC_TexExp.FSG50.FSG-Stock');
	
	L.AddPrecacheStaticMesh(StaticMesh'BWBP_SKC_StaticExp.FG50.FG50PickupHi');
	L.AddPrecacheStaticMesh(StaticMesh'BWBP_SKC_StaticExp.FG50.FG50AmmoPickup');
}
simulated function UpdatePrecacheMaterials()
{
	Level.AddPrecacheMaterial(Texture'BWBP_SKC_TexExp.FG50.FG50-Main');
	Level.AddPrecacheMaterial(Texture'BWBP_SKC_TexExp.FG50.FG50-Misc');
	Level.AddPrecacheMaterial(Texture'BWBP_SKC_TexExp.FG50.FG50-Screen');
...
simulated function UpdatePrecacheStaticMeshes()
{
	...
	Level.AddPrecacheStaticMesh(StaticMesh'BWBP_SKC_StaticExp.FG50.FG50AmmoPickup');
}
