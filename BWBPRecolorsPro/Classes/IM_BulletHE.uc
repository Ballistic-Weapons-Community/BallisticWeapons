...
defaultproperties
{
     HitEffects(0)=Class'BWBPRecolorsPro.IE_BulletHE'
     HitEffects(1)=Class'BWBPRecolorsPro.IE_BulletHE'
     HitEffects(2)=Class'BWBPRecolorsPro.IE_BulletHE'
     HitEffects(3)=Class'BWBPRecolorsPro.IE_BulletHE'
     HitEffects(4)=Class'BWBPRecolorsPro.IE_BulletHE'
     HitEffects(5)=Class'BWBPRecolorsPro.IE_BulletHE'
     HitEffects(6)=Class'BWBPRecolorsPro.IE_BulletHE'
     HitEffects(7)=Class'BWBPRecolorsPro.IE_BulletHE'
     HitEffects(8)=Class'BWBPRecolorsPro.IE_BulletHE'
