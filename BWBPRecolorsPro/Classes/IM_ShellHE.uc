...
defaultproperties
{
     HitEffects(0)=Class'BWBPRecolorsPro.IE_ShellHE'
     HitEffects(1)=Class'BWBPRecolorsPro.IE_ShellHE'
     HitEffects(2)=Class'BWBPRecolorsPro.IE_ShellHE'
     HitEffects(3)=Class'BWBPRecolorsPro.IE_ShellHE'
     HitEffects(4)=Class'BWBPRecolorsPro.IE_ShellHE'
     HitEffects(5)=Class'BWBPRecolorsPro.IE_ShellHE'
     HitEffects(6)=Class'XEffects.pclredsmoke'
     HitEffects(7)=Class'BWBPRecolorsPro.IE_ShellHE'
     HitEffects(8)=Class'BWBPRecolorsPro.IE_ShellHE'
