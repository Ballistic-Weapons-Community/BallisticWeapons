...
defaultproperties
{
     ...
     Weapons(11)=(ClassName="BallisticProV55.AM67Pistol",ItemName="AM67 Assault Pistol",SmallIconMaterial=Texture'BallisticUI2.Icons.SmallIcon_AM67',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=3,BigIconMaterial=Texture'BallisticUI2.Icons.BigIcon_AM67',bIsBW=True)
     ...
     Weapons(20)=(ClassName="BallisticProV55.M290Shotgun",ItemName="M290 Shotgun",SmallIconMaterial=Texture'BallisticUI2.Icons.SmallIcon_M290',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=7,BigIconMaterial=Texture'BallisticUI2.Icons.BigIcon_M290',InventorySize=24,bIsBW=True)
     ...
     Weapons(23)=(ClassName="BallisticProV55.HVCMk9LightningGun",ItemName="HVC-Mk9 Lightning Gun",SmallIconMaterial=Texture'BWBP2-Tex.Lighter.SmallIcon_LG',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=5,BigIconMaterial=Texture'BallisticUI2.Icons.BigIcon_HVCMk9',InventorySize=24,bIsBW=True)
     Weapons(24)=(ClassName="BallisticProV55.RX22AFlamer",ItemName="RX22A Flame Thrower",SmallIconMaterial=Texture'BallisticUI2.Icons.SmallIcon_RX22A',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=8,BigIconMaterial=Texture'BallisticUI2.Icons.BigIcon_RX22A',InventorySize=24,bIsBW=True)
     Weapons(25)=(ClassName="BallisticProV55.XMV850Minigun",ItemName="XMV-850 Minigun",SmallIconMaterial=Texture'BallisticUI2.Icons.SmallIcon_XMV850',SmallIconCoords=(X2=127,Y2=31),InventoryGroup=6,BigIconMaterial=Texture'BallisticUI2.Icons.BigIcon_XMV850',InventorySize=12,bIsBW=True)
