...
defaultproperties
{
    ...
    ClassDescriptions(2)="Sidearm-class weapons are quick to switch to, can be aimed very quickly, and generally have good point shooting properties. They are less affected by the lockdown of melee weapons, and have no speed penalty when aimed.||However, as they are smaller than full size weapons, they have particular drawbacks,such as lower damage output, lower range, smaller magazine size or unfavourable recoil properties."
    ClassDescriptions(3)="Personal defense weapons are intended for close combat. They can be aimed quickly, deal good damage and are effective when shoulder fired, but are ineffective outside of close range.||Submachine guns provide very controllable automatic fire.||Machine pistols provide higher damage and strong burst damage output, but sacrifice effective range." 
