...
static function string MakeURLFor(GameProfile G)
{
    ...
    return x$"?mutator=BWInteractions3DE.MutBWInteractions,BallisticDE.Mut_ConflictLoadout,BallisticDE.Mut_Killstreak,BallisticDE.Mut_AddHealth,BallisticDE.Mut_ChargeSprinter,BallisticDE.Mut_BloodyHell,BallisticVehiclesDE.Mut_BWVehicles,HUDFix.MutHUDFix";
}
