...
static function string MakeURLFor(GameProfile G)
{
    ...
    return x$"?mutator=BWInteractions3.MutBWInteractions,BallisticProV55.Mut_ConflictLoadout,BallisticProV55.Mut_BloodyHell,BWBP_VPC_Pro.Mut_BWVehicles,HUDFix.MutHUDFix";
}
