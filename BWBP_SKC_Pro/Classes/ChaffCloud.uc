...
//=============================================================================
class ChaffCloud extends BallisticEmitter
	placeable;

var   AvoidMarker		Fear;			// Da phear spauwt...
var   ChaffCloudControl	MyControl;		// The cloud controlling actor
...
simulated function PostBeginPlay()
{
	...
	MyControl = ChaffCloudControl(Owner);
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'BWBP_SKC_Pro.ChaffCloud.SpriteEmitter1'
     ...
     End Object
     Emitters(1)=SpriteEmitter'BWBP_SKC_Pro.ChaffCloud.SpriteEmitter0'
