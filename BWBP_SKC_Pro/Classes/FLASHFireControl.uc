...
/*    if (ImpactManager != None)
	...
	{
		if (xPawn(A) != None && Level.Game != None && Level.Game.ReduceDamage(Damage, xPawn(A), Instigator, Location, Dummy, class'DT_M202Immolation') <= 0)
			continue;
		if (xPawn(A)!=None)
			IgniteActor(A);
...
defaultproperties
{
     ...
     Damage=25
     DamageType=Class'BWBP_SKC_Pro.DT_M202Burned'
