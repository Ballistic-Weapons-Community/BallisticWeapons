...
//=============================================================================
class MARSSparkEmitterRed extends BallisticEmitter
	placeable;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         StartSizeRange=(X=(Min=1.000000,Max=4.000000),Y=(Min=2.000000,Max=2.000000),Z=(Min=2.000000,Max=2.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'BWBP_SKC_Pro.MARSSparkEmitterRed.SpriteEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'BWBP_SKC_Pro.MARSSparkEmitterRed.SpriteEmitter1'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter0
         ...
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=0.300000),Y=(Min=0.300000,Max=0.300000),Z=(Min=0.300000,Max=0.300000))
     ...
     End Object
     Emitters(2)=BeamEmitter'BWBP_SKC_Pro.MARSSparkEmitterRed.BeamEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         ColorMultiplierRange=(X=(Min=0.000000),Y=(Min=0.000000,Max=0.208000),Z=(Min=0.000000,Max=0.200000))
         Opacity=0.500000
         CoordinateSystem=PTCS_Relative
         MaxParticles=6
         ...
         LifetimeRange=(Min=0.300000,Max=0.300000)
     End Object
     Emitters(3)=SpriteEmitter'BWBP_SKC_Pro.MARSSparkEmitterRed.SpriteEmitter2'
