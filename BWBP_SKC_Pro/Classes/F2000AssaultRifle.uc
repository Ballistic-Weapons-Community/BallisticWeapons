...
function float GetAIRating()
{
	...
	return class'BUtil'.static.DistanceAtten(Rating, 0.5, Dist, BallisticInstantFire(BFireMode[0]).DecayRange.Min, BallisticInstantFire(BFireMode[0]).DecayRange.Max); 
}
