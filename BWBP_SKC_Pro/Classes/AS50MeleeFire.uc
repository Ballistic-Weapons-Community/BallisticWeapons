...
//=============================================================================
class AS50MeleeFire extends BallisticMeleeFire;
...
defaultproperties
{
     ...
     DamageType=Class'BWBP_SKC_Pro.DTAS50Melee'
     DamageTypeHead=Class'BWBP_SKC_Pro.DTAS50Melee'
     DamageTypeArm=Class'BWBP_SKC_Pro.DTAS50Melee'
     bUseWeaponMag=False
     bReleaseFireOnDie=False
     bIgnoreReload=True
     ScopeDownOn=SDO_PreFire
     BallisticFireSound=(Sound=Sound'BW_Core_WeaponSound.M763.M763Swing',Volume=0.35,Radius=32.000000,bAtten=True)
     bAISilent=True
     bFireOnRelease=True
