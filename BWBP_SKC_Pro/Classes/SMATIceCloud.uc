...
// SMATIceCloud.
//
// A cloud of freezing gas from a SMAT Ice rocket. 
// The controller wil damage and slow the actors this is touching
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class SMATIceCloud extends BallisticEmitter
	placeable;

var   AvoidMarker		Fear;			// Da phear spauwt...
var   SMATIceCloudControl	MyControl;		// The cloud controlling actor
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'BWBP_SKC_Pro.SMATIceCloud.SpriteEmitter1'
     ...
     End Object
     Emitters(1)=SpriteEmitter'BWBP_SKC_Pro.SMATIceCloud.SpriteEmitter0'

     AutoDestroy=True
     CollisionRadius=292.000000
