...
defaultproperties
{
    WeaponClass=Class'BWBP_SKC_Pro.HVPCMk66PlasmaCannon'
     ...
     MyRadiusDamageType=Class'BWBP_SKC_Pro.DT_BFGChargeSmall'
     bUsePositionalDamage=True
     
     
     DamageTypeHead=Class'BWBP_SKC_Pro.DT_BFGChargeSmall'
     ...
     MyDamageType=Class'BWBP_SKC_Pro.DT_BFGChargeSmall'
     LightType=LT_Steady
