...
defaultproperties
{
     ...
     BringUpSound=(Sound=Sound'BW_Core_WeaponSound.EKS43.EKS-Pullout',Volume=0.148000)
     PutDownSound=(Sound=Sound'BW_Core_WeaponSound.EKS43.EKS-Putaway',Volume=0.148000)
     MagAmmo=1
     bNoMag=True
     GunLength=0.000000
