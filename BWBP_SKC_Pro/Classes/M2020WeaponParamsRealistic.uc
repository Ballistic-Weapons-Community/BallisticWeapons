...
defaultproperties
{
	...
	Begin Object Class=InstantEffectParams Name=RealisticPrimaryEffectParams_Supp
		...
		MuzzleFlashClass=Class'BWBP_SKC_Pro.M2020FlashEmitter'
		FlashScaleFactor=1.200000
		FireSound=(Sound=Sound'BWBP_SKC_Sounds.M2020.M2020-FireGaussAlt',Volume=1.250000)
		Recoil=2000.000000
		Chaos=-1.0
		Inaccuracy=(X=1,Y=1)
		BotRefireRate=0.900000
	...
	//Gauss Offline Supp
	Begin Object Class=InstantEffectParams Name=RealisticPrimaryEffectParamsOffline_Supp
		TraceRange=(Min=1800.000000,Max=9000.000000) //7.62x51mm
		WaterTraceRange=5000.0
		DecayRange=(Min=0.0,Max=0.0)
		RangeAtten=0.1
	...
	Begin Object Class=FireParams Name=RealisticPrimaryFireParamsOffline_Supp
		FireInterval=0.110000
		BurstFireRateFactor=1.00
		FireAnim="FireUnPowered"
		FireEndAnim=	
	FireEffectParams(0)=InstantEffectParams'RealisticPrimaryEffectParamsOffline_Supp'
	End Object	
