...
//=============================================================================
class IM_HMCSmall extends BCImpactManager;
...
defaultproperties
{
     ...
     HitDecals(0)=Class'BWBP_SKC_Pro.AD_HMCSmall'
     HitDecals(1)=Class'BWBP_SKC_Pro.AD_HMCSmall'
     HitDecals(2)=Class'BWBP_SKC_Pro.AD_HMCSmall'
     HitDecals(3)=Class'BWBP_SKC_Pro.AD_HMCSmall'
     HitDecals(4)=Class'BWBP_SKC_Pro.AD_HMCSmall'
     HitDecals(5)=Class'BWBP_SKC_Pro.AD_HMCSmall'
     HitDecals(6)=Class'BWBP_SKC_Pro.AD_HMCSmall'
     HitDecals(7)=Class'BWBP_SKC_Pro.AD_HMCSmall'
     HitDecals(8)=Class'BWBP_SKC_Pro.AD_HMCSmall'
     HitDecals(10)=Class'BWBP_SKC_Pro.AD_HMCSmall'
