...
//=============================================================================
class AK490MeleeFire extends BallisticMeleeFire;
...
defaultproperties
{
     DamageType=Class'BWBP_SKC_Pro.DT_AK490Hit'
     DamageTypeHead=Class'BWBP_SKC_Pro.DT_AK490HitHead'
     DamageTypeArm=Class'BWBP_SKC_Pro.DT_AK490Hit'
     KickForce=100
     bUseWeaponMag=False
     bReleaseFireOnDie=False
     bIgnoreReload=True
     ScopeDownOn=SDO_PreFire
     BallisticFireSound=(Sound=Sound'BW_Core_WeaponSound.Marlin.Mar-Melee',Volume=0.5,Radius=12.000000,batten=false)
     bAISilent=True
     bFireOnRelease=True
     PreFireAnim="PrepBash"
     FireAnim="Bash"
