...
{     
    MaxDistFactor=0.250000
     ...
     PrecachePickups(53)=Class'BWBP_SKC_Pro.CYLOPickup'
     PrecachePickups(54)=Class'BWBP_SKC_Pro.CoachGunPickup'
     PrecachePickups(55)=Class'BWBP_SKC_Pro.DragonsToothPickup'
     PrecachePickups(56)=Class'BWBP_SKC_Pro.FG50Pickup'
     PrecachePickups(57)=Class'BWBP_SKC_Pro.FLASHPickup'
     PrecachePickups(58)=Class'BWBP_SKC_Pro.G28Pickup'
     PrecachePickups(59)=Class'BWBP_SKC_Pro.ICISPickup'
     PrecachePickups(60)=Class'BWBP_SKC_Pro.LAWPickup'
     PrecachePickups(61)=Class'BWBP_SKC_Pro.LK05Pickup'
     PrecachePickups(62)=Class'BWBP_SKC_Pro.LonghornPickup'
     PrecachePickups(63)=Class'BWBP_SKC_Pro.LS14Pickup'
     PrecachePickups(64)=Class'BWBP_SKC_Pro.M2020GaussPickup'
     PrecachePickups(65)=Class'BWBP_SKC_Pro.MRDRPickup'
     PrecachePickups(66)=Class'BWBP_SKC_Pro.MARSPickup'
     PrecachePickups(67)=Class'BWBP_SKC_Pro.MGLPickup'
     PrecachePickups(68)=Class'BWBP_SKC_Pro.MK781Pickup'
     PrecachePickups(69)=Class'BWBP_SKC_Pro.PS9mPickup'
     PrecachePickups(70)=Class'BWBP_SKC_Pro.SK410Pickup'
     PrecachePickups(71)=Class'BWBP_SKC_Pro.SKASPickup'
     PrecachePickups(72)=Class'BWBP_SKC_Pro.X82Pickup'
     PrecachePickups(73)=Class'BWBP_SKC_Pro.X8Pickup'
     PrecachePickups(74)=Class'BWBP_SKC_Pro.XM84Pickup'

     PrecachePickups(75)=Class'BWBP_OP_Pro.AkeronPickup'
     PrecachePickups(76)=Class'BWBP_OP_Pro.KF8XPickup'
     PrecachePickups(77)=Class'BWBP_OP_Pro.CX61Pickup'
     PrecachePickups(78)=Class'BWBP_OP_Pro.CX85Pickup'
     PrecachePickups(79)=Class'BWBP_OP_Pro.DefibFistsPickup'
     PrecachePickups(80)=Class'BWBP_OP_Pro.PD97Pickup'
     PrecachePickups(81)=Class'BWBP_OP_Pro.ProtonStreamPickup'
     PrecachePickups(82)=Class'BWBP_OP_Pro.R9A1Pickup'
     PrecachePickups(83)=Class'BWBP_OP_Pro.RaygunPickup'
     PrecachePickups(84)=Class'BWBP_OP_Pro.WrenchPickup'
     PrecachePickups(85)=Class'BWBP_OP_Pro.XOXOPickup'
     PrecachePickups(86)=Class'BWBP_OP_Pro.Z250Pickup'
