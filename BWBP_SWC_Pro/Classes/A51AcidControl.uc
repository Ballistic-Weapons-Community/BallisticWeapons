...
//=============================================================================
class A51AcidControl extends Actor;
...
simulated function Initialize(vector HitNormal, int Load)
{
	...
	for(i = 0; i < Count; i++)
	{
		if(i > 0)
		{
			...
			GF = Spawn(class'A51GroundAcid',self,,HitLoc, rotator(HitNorm));
		}
		else
			GF = Spawn(class'A51GroundAcid',self,,Location, rot(0,0,0));
