...
defaultproperties
{
	...
	WeaponList(39)=Class'BWBP_OP_Pro.XM20AutoLas'
	...
	WeaponList(60)=Class'BWBP_SKC_Pro.MRDRMachinePistol'

	// handgun
	WeaponList(61)=Class'BallisticProV55.BOGPPistol'
	WeaponList(62)=Class'BallisticProV55.AM67Pistol'
	WeaponList(63)=Class'BWBP_SKC_Pro.AH250Pistol'
	WeaponList(64)=Class'BallisticProV55.D49Revolver'
	WeaponList(65)=Class'BallisticProV55.leMatRevolver'
	WeaponList(66)=Class'BallisticProV55.MRT6Shotgun'
	WeaponList(67)=Class'BallisticProV55.RS8Pistol'
	WeaponList(68)=Class'BallisticProV55.MD24Pistol'
	WeaponList(69)=Class'BallisticProV55.A42SkrithPistol'
	WeaponList(70)=Class'BWBP_SKC_Pro.PS9mPistol'

	WeaponList(71)=Class'BWBP_OP_Pro.FlameSword' // the melee section just sucks
}