class SRKSmgPlagueTrigger extends Trigger;

var byte Team;
var	Pawn						PawnOwner;
var   Controller				InstigatorController;
var SRKSmgPlagueEffect 	PlagueEffect;
...
function TryPlague(xPawn P)
{
	...
	foreach P.BasedActors(class'SRKSmgPlagueEffect', RPE)
		break;

	if (RPE == None)
	{
		RPE = Spawn(class'SRKSmgPlagueEffect',P,,P.Location);// + vect(0,0,-30));
		RPE.Initialize(P);
