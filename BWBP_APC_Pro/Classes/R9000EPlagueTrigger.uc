class R9000EPlagueTrigger extends Trigger;

var byte Team;
var	Pawn						PawnOwner;
var   Controller				InstigatorController;
var R9000EPlagueEffect 	PlagueEffect;
...
function TryPlague(xPawn P)
{
	...
	foreach P.BasedActors(class'R9000EPlagueEffect', RPE)
		break;

	if (RPE == None)
	{
		RPE = Spawn(class'R9000EPlagueEffect',P,,P.Location);// + vect(0,0,-30));
		RPE.Initialize(P);
