...
{
	L.AddPrecacheMaterial(Texture'BWBP_APC_Tex.Ar.ARScopeMain');
	L.AddPrecacheMaterial(Texture'BWBP_APC_Tex.Ar.ARMain');
...
defaultproperties
{
     ...
     StaticMesh=StaticMesh'BWBP_APC_Static.ZX98.ZX98PickupHi'
     Physics=PHYS_None
	DrawScale=0.250000
