//=============================================================================
// The emitter for the Leopard tank's Short smoke dispensers.

// by Logan "BlackEagle" Richert.
// Copyright(c) 2008. All Rights Reserved.
//=============================================================================

class ShortLeopardSmoke extends Emitter
	placeable;
...
simulated function SmokeScale(float SmokeSize)
{
	Emitters[1].StartSizeRange.X.Min = SmokeSize / 2.0;
	Emitters[1].StartSizeRange.X.Max = SmokeSize / 2.0;
	Emitters[1].StartSizeRange.Y.Min = SmokeSize / 2.0;
	Emitters[1].StartSizeRange.Y.Max = SmokeSize / 2.0;
	Emitters[1].StartSizeRange.Z.Min = SmokeSize / 2.0;
	Emitters[1].StartSizeRange.Z.Max = SmokeSize / 2.0;
}
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=MeshEmitter'BWBP_VPC_Pro.ShortLeopardSmoke.MeshEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         StartVelocityRange=(X=(Min=-12.000000,Max=12.000000),Y=(Min=-12.000000,Max=12.000000),Z=(Min=10.000000,Max=20.000000))
     End Object
     Emitters(1)=SpriteEmitter'BWBP_VPC_Pro.ShortLeopardSmoke.SpriteEmitter0'
