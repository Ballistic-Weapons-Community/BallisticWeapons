//-----------------------------------------------------------
//MachineGun Pawn for Rhino
//-----------------------------------------------------------
class RhinoMGPawn extends ONSWeaponPawn;
...
defaultproperties
{
     GunClass=Class'BWBP_VPC_Pro.RhinoMG'
     ...
     VehiclePositionString="in a Rhino's MG turret"
     VehicleNameString="Rhino Machinegun"
}
