//-----------------------------------------------------------
// The TOW missile projectile for the KH MarkII Cobra.

// by Logan "BlackEagle" Richert.
// Copyright(c) 2008. All Rights Reserved.
//-----------------------------------------------------------
class KHMKIITrackRocket extends Projectile
	placeable;

var 			Actor 						HomingTarget;
var 			vector 						InitialDir;
var 			float 						AccelerationAddPerSec;
var 			float 						LeadTargetDelay; // Doesn't work.
var 			float 						LeadTargetStartTime; // Doesn't work.
...
// Increases the speed of the missile gradually, But doesn't work...
...
defaultproperties
{
     ...
     MyDamageType=Class'BWBP_VPC_Pro.KHMKIIDamTypeRocket'
