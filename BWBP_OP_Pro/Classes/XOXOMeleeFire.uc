...
defaultproperties
{
     DamageType=Class'BWBP_OP_Pro.DTXOXOStab'
     DamageTypeHead=Class'BWBP_OP_Pro.DTXOXOStab'
     DamageTypeArm=Class'BWBP_OP_Pro.DTXOXOStab'
     KickForce=100
     ...
     BallisticFireSound=(Sound=Sound'BWBP_OP_Sounds.XOXO.XOXO-Stab',Volume=0.5,Radius=12.000000,batten=false)
     bAISilent=True
     bFireOnRelease=True
