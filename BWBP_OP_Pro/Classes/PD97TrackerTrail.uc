class PD97TrackerTrail extends Emitter;

defaultproperties
{
     Begin Object Class=SpriteEmitter Name=PD97TrackerTrailEmitter1
         UseColorScale=True
         FadeOut=True
         FadeIn=True
         UniformSize=True
     ...
     End Object
     Emitters(0)=SpriteEmitter'BWBP_OP_Pro.PD97TrackerTrail.PD97TrackerTrailEmitter1'

     Begin Object Class=SparkEmitter Name=PD97TrackerSparkEmitter1
     ...
     End Object
     Emitters(1)=SparkEmitter'BWBP_OP_Pro.PD97TrackerTrail.PD97TrackerSparkEmitter1'
