...
replication
{
	reliable if (Role == ROLE_Authority)
		ClientSetHeat, ClientScreenStart, bLaserOn, bOvercharged, ChargeRate;
}
...
simulated function BringUp(optional Weapon PrevWeapon)
{
	...
	{
		Laser = Spawn(class'BWBP_OP_Pro.LaserActor_XM20BRed');
	}
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BWBP_OP_Pro.XM20BPrimaryFire'
     FireModeClass(1)=Class'BWBP_OP_Pro.XM20BSecondaryFire'
     ...
     PickupClass=Class'BWBP_OP_Pro.XM20BPickup'
     PlayerViewOffset=(X=6.000000,Y=1.000000,Z=-15.000000)
     BobDamping=1.800000
     AttachmentClass=Class'BWBP_OP_Pro.XM20BAttachment'
