...
defaultproperties
{
	 ...
	 Deployables=(dClass=Class'BWBPSomeOtherPack.WrenchGunEnergyBarrier',WarpInTime=0.500000,CheckSlope=False,CooldownDelay=2.00,dDescription="A five-second barrier of infinite durability.")
     TeamSkins(0)=(RedTex=Shader'BallisticWeapons2.Hands.RedHand-Shiny',BlueTex=Shader'BallisticWeapons2.Hands.BlueHand-Shiny')
     BigIconMaterial=Texture'BWBPSomeOtherPackTex.Wrenchgun.BigIcon_Wrenchgun'
     ...
     MeleeFireClass=Class'BWBPSomeOtherPack.WrenchgunMeleeFire'
     ...
     FireModeClass(0)=Class'BWBPSomeOtherPack.WrenchgunPrimaryFire'
     FireModeClass(1)=Class'BWBPSomeOtherPack.WrenchgunSecondaryFire'
     ...
     Mesh=SkeletalMesh'BWBPSomeOtherPackAnims.Wrenchgun_FP'
     DrawScale=1.250000
     Skins(0)=Shader'BallisticWeapons2.Hands.Hands-Shiny'
     Skins(1)=Texture'BallisticRecolors4TexPro.CoachGun.DBL-Main'
     Skins(2)=Texture'BWBPSomeOtherPackTex.Misc.WrenchShells'
     Skins(3)=Texture'BWBPSomeOtherPackTex.Misc.WrenchShells'
