class LDGBallisticONS extends ONSOnslaughtGame;
...
defaultproperties
{
     ...
     MapListType="LDGGameBW.LDGBallisticONSMapList"
     MutatorClass="LDGGameBW.LDGBWONSMutator"
     GameName="LDG Ballistic Onslaught"
