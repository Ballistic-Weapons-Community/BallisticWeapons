class LDGBallisticCTF extends xCTFGame;
...
defaultproperties
{
     ...
     MapListType="LDGGameBW.LDGBallisticCTFMapList"
     MutatorClass="LDGGameBW.LDGBWCTFMutator"
     GameName="LDG Ballistic Capture The Flag"
