class Game_Freon extends Freon;
...
defaultproperties
{
     ...
     BWMutators(0)="LDGGameBW.MutThawProtection"
     BWMutators(1)="LDGGameBW.MutUTCompBW_LDG_FR"
     BWMutators(2)="BWInteractions3.MutBWInteractions"
     HintColor=(B=255,G=255,R=255,A=255)
     DefaultPlayerClassName="LDGGameBW.Freon_Pawn_Normal"
     MapListType="LDGGameBW.MapList_Freon"
     MutatorClass="LDGGameBW.DefMut_Freon"
