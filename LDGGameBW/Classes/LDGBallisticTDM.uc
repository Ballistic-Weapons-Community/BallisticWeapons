class LDGBallisticTDM extends xTeamGame;
...
defaultproperties
{
     ...
     BWMutators(0)="BallisticProV55.Mut_BallisticSwap"
	 BWMutators(1)="BallisticProV55.Mut_Killstreak"
     BWMutators(2)="BallisticProV55.Mut_Regeneration"
     BWMutators(3)="BallisticProV55.Mut_ChargeSprinter"
     BWMutators(4)="LDGGameBW.MutUTCompBW_LDG"
     ...
     MapListType="LDGGameBW.LDGBallisticTDMMapList"
     MutatorClass="LDGGameBW.LDGBWTDMMutator"
     GameName="LDG Ballistic Team Death Match"
