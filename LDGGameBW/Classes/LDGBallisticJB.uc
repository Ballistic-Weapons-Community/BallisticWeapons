class LDGBallisticJB extends Jailbreak;
...
defaultproperties
{
     ...
     BWMutators(2)="LDGGameBW.MutUTCompBW_LDG"
     ...
     MapListType="LDGGameBW.LDGBallisticJBMapList"
     MutatorClass="LDGGameBW.LDGJBMutator"
