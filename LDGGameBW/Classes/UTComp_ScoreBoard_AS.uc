...
function GetSuitableFontForHeight(Canvas C, float maxHeight, out Font F, out float fontHeight, out int Type)
{
	local int i;
	local Font F2, Orig;
	local float XL,YL;
...
function DrawColoredNameCorrectly(Canvas C, string PlayerName)
{
...
function PlayerReplicationInfo GetPRI (UTComp_PRI uPRI)
{
  local int i;
