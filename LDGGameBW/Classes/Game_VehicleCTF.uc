class Game_VehicleCTF extends xVehicleCTFGame;
...
defaultproperties
{
     ...
     BWMutators(0)="LDGGameBW.MutUTCompBW_LDG"
     ...
     MapListType="LDGGameBW.MapList_VehicleCTF"
     MutatorClass="LDGGameBW.DefMut_VehicleCTF"
