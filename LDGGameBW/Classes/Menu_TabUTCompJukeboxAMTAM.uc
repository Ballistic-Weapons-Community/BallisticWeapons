class Menu_TabUTCompJukeboxAMTAM extends UT2k3TabPanel;
...
event Opened(GUIComponent Sender)
{
	...
	PC = Misc_Player_UTComp_LDG(PlayerOwner());
...
defaultproperties
{
     ...
     Begin Object Class=GUIImage Name=TabBackground
         ...
         bNeverFocus=True
     End Object
     Controls(0)=GUIImage'LDGGameBW.Menu_TabUTCompJukeboxAMTAM.TabBackground'
     ...
     Begin Object Class=GUILabel Name=Info
         ...
         WinHeight=0.500000
     End Object
     Controls(1)=GUILabel'LDGGameBW.Menu_TabUTCompJukeboxAMTAM.Info'
     ...
     Begin Object Class=GUILabel Name=MusicForThisMap
         ...
         WinHeight=0.040000
     End Object
     Controls(2)=GUILabel'LDGGameBW.Menu_TabUTCompJukeboxAMTAM.MusicForThisMap'
     ...
     Begin Object Class=moComboBox Name=MusicComboBox
         ...
         WinWidth=0.400000
         WinHeight=0.060000
         OnChange=Menu_TabUTCompJukeboxAMTAM.InternalOnChange
     End Object
     Controls(3)=moComboBox'LDGGameBW.Menu_TabUTCompJukeboxAMTAM.MusicComboBox'
     ...
     Begin Object Class=moCheckBox Name=OverrideLevelMusic
         ...
         OnChange=Menu_TabUTCompJukeboxAMTAM.InternalOnChange
     End Object
     Controls(4)=moCheckBox'LDGGameBW.Menu_TabUTCompJukeboxAMTAM.OverrideLevelMusic'
     ...
     Begin Object Class=moCheckBox Name=AutoDownloadLevelMusic
         ...
         OnChange=Menu_TabUTCompJukeboxAMTAM.InternalOnChange
     End Object
     Controls(5)=moCheckBox'LDGGameBW.Menu_TabUTCompJukeboxAMTAM.AutoDownloadLevelMusic'
     ...
     Begin Object Class=GUIButton Name=DownloadButton
         ...
         WinWidth=0.180000
         WinHeight=0.060000
         OnClick=Menu_TabUTCompJukeboxAMTAM.InternalOnClick
         OnKeyEvent=DownloadButton.InternalOnKeyEvent
     End Object
     Controls(6)=GUIButton'LDGGameBW.Menu_TabUTCompJukeboxAMTAM.DownloadButton'
     ...
     End Object
     Controls(7)=GUIButton'LDGGameBW.Menu_TabUTCompJukeboxAMTAM.RefreshButton'
     ...
     End Object
     Controls(8)=GUIButton'LDGGameBW.Menu_TabUTCompJukeboxAMTAM.InstallButton'
