class UTComp_xDeathMessageBW extends UTComp_xDeathMessageB;
	...
	)
{
	...
	else if(class'UTComp_xDeathMessage'.default.bEnableTeamColoredDeaths)
	{
		if(RelatedPRI_2.Team != None && RelatedPRI_2.Team.TeamIndex == 0)
			VictimName = MakeColorCode(class'UTComp_xPlayer'.default.RedMessageColor) $ RelatedPRI_2.PlayerName$MakeColorCode(class'HUD'.Default.GreenColor);
		else if(RelatedPRI_2.Team != None && RelatedPRI_2.Team.TeamIndex == 1)
			VictimName = MakeColorCode(class'UTComp_xPlayer'.default.BlueMessageColor) $ RelatedPRI_2.PlayerName$MakeColorCode(class'HUD'.Default.GreenColor);
		else
			VictimName = MakeColorCode(class'HUD'.default.GoldColor) $ RelatedPRI_2.PlayerName$MakeColorCode(class'HUD'.Default.GreenColor);
	}
	...
	else if(class'UTComp_xDeathMessage'.default.bEnableTeamColoredDeaths)
	{
		if(RelatedPRI_1.Team != None && RelatedPRI_1.Team.TeamIndex == 0)
			KillerName = MakeColorCode(class'UTComp_xPlayer'.default.RedMessageColor) $ RelatedPRI_1.PlayerName$MakeColorCode(class'HUD'.Default.GreenColor);
		else if(RelatedPRI_1.Team != None && RelatedPRI_1.Team.TeamIndex == 1)
			KillerName = MakeColorCode(class'UTComp_xPlayer'.default.BlueMessageColor) $ RelatedPRI_1.PlayerName$MakeColorCode(class'HUD'.Default.GreenColor);
		else
			KillerName = MakeColorCode(class'HUD'.default.GoldColor) $ RelatedPRI_1.PlayerName$MakeColorCode(class'HUD'.default.GreenColor);
	}
	else if(class'UTComp_xDeathMessage'.default.DrawColoredNamesInDeathMessages)
	{
		if(uPRI!=None && uPRI.ColoredName != "")
	...
	if (Switch == 2 && class<BallisticDamageType>(OptionalObject) != None && class'BallisticDamageType'.default.bSimpleDeathMessages)
		return class'GameInfo'.static.ParseKillMessage(
			KillerName, 
			VictimName, 
			class<BallisticDamageType>(OptionalObject).static.ScopedDeathMessage(RelatedPRI_1, RelatedPRI_2));
