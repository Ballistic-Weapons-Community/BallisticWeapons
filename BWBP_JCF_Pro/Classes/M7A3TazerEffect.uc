...
simulated function SetTarget(Pawn Targ)
{
	...
	if (Flash == None)
		Flash = spawn(class'M7A3PlayerEffect',Targ);
}
...
simulated function UpdateTargets()
{
	...
	if (Flash == None)
		Flash = spawn(class'M7A3PlayerEffect',Target);
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=BeamEmitter'BWBP_JCF_Pro.M7A3TazerEffect.BeamEmitter5'
