...
//=============================================================================
class BG_ScnBlood extends BallisticEmitter
	placeable;

#exec OBJ LOAD FILE=BallisticBloodPro.utx
...
event PostBeginPlay()
{
	...
	F = FRand();
	if (F <= 0.25)
		Emitters[0].Texture=Texture'BallisticBloodPro.Decals.Spatter1';
	else if (F <= 0.5)
		Emitters[0].Texture=Texture'BallisticBloodPro.Decals.Spatter2';
	else if (F <= 0.75)
		Emitters[0].Texture=Texture'BallisticBloodPro.Decals.Spatter3';
	else
		Emitters[0].Texture=Texture'BallisticBloodPro.Decals.Spatter4';
}
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         Texture=Texture'BallisticBloodPro.Decals.Spatter1'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=3.000000,Max=3.000000)
         StartVelocityRange=(Z=(Min=-0.500000,Max=-0.300000))
     End Object
     Emitters(0)=SpriteEmitter'BallisticProV55.BG_ScnBlood.SpriteEmitter0'
