...
// RSNovaSoul.
//
// A soul actor created when a player is killed by a novastaff.
// Souls can be collected by novastaff wielders to get super powers.
// Souls have some AI and try to follow the killer and run away from pain.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2007 RuneStorm. All Rights Reserved.
//=============================================================================
class RSNovaSoul extends BallisticEmitter;
...
static function RSNovaSoul SpawnSoul(vector StartLoc, Pawn Killer, Pawn Victim, actor ControlActor)
{
	local RSNovaSoul Soul;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=TrailEmitter'BallisticProV55.RSNovaSoul.TrailEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'BallisticProV55.RSNovaSoul.SpriteEmitter6'
     ...
     End Object
     Emitters(2)=SpriteEmitter'BallisticProV55.RSNovaSoul.SpriteEmitter7'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter8
         ...
         ColorScale(1)=(RelativeTime=0.400000,Color=(B=255,G=96,A=255))
     ...
     End Object
     Emitters(3)=SpriteEmitter'BallisticProV55.RSNovaSoul.SpriteEmitter8'
