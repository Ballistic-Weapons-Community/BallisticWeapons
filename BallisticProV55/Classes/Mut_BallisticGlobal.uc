...
defaultproperties
{
     ...
     InventoryModes(1)="Outfitting Loadout"
     InventoryModes(2)="Conflict Loadout"
	 InventoryModes(3)="Evolution Loadout"
     InventoryModes(4)="Arena Loadout"
	 InventoryModes(5)="Knockout Melee"
