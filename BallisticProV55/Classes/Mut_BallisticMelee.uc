...
defaultproperties
{
     ...
     Replacements(3)=(OldItem=Class'XWeapons.ShockRiflePickup',NewItemNames=("BallisticProV55.Melee_M50Pickup"))
     ...
     Replacements(7)=(OldItem=Class'XWeapons.RocketLauncherPickup',NewItemNames=("BallisticProV55.EKS43Pickup"))
     Replacements(8)=(OldItem=Class'XWeapons.SniperRiflePickup',NewItemNames=("BallisticProV55.A909Pickup"))
     Replacements(9)=(OldItem=Class'XWeapons.PainterPickup',NewItemNames=("BallisticProV55.Melee_M50Pickup"))
     Replacements(10)=(OldItem=Class'XWeapons.RedeemerPickup',NewItemNames=("BallisticProV55.Melee_M50Pickup"))
     Replacements(11)=(OldItem=Class'UTClassic.ClassicSniperRiflePickup',NewItemNames=("BallisticProV55.A909Pickup"))
     Replacements(12)=(OldItem=Class'Onslaught.ONSAVRiLPickup',NewItemNames=("BallisticProV55.EKS43Pickup"))
     Replacements(13)=(OldItem=Class'Onslaught.ONSGrenadePickup',NewItemNames=("BallisticProV55.Melee_M763Pickup"))
     Replacements(14)=(OldItem=Class'Onslaught.ONSMineLayerPickup',NewItemNames=("BallisticProV55.Melee_A73Pickup"))
     Replacements(15)=(OldItem=Class'OnslaughtFull.ONSPainterPickup',NewItemNames=("BallisticProV55.Melee_M50Pickup"))
