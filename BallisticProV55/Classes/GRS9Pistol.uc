...
{
	if (!FireMode[1].IsFiring() && level.TimeSeconds - GRS9SecondaryFire(FireMode[1]).StopFireTime >= 0.8 && LaserAmmo == default.LaserAmmo && class'BallisticReplicationInfo'.default.GameStyle != 2/* && !IsInState('DualAction') && !IsInState('PendingDualAction')*/)
	{
