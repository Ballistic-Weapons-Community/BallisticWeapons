...
// IM_KnifeThrown.
//
// ImpactManager subclass for thrown knives
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2005 RuneStorm. All Rights Reserved.
//=============================================================================
class IM_KnifeThrown extends BCImpactManager;
...
defaultproperties
{
     ...
     HitSounds(0)=SoundGroup'BW_Core_WeaponSound.Knife.KnifeConcreteHit'
     HitSounds(1)=SoundGroup'BW_Core_WeaponSound.Knife.KnifeConcreteHit'
     HitSounds(2)=SoundGroup'BW_Core_WeaponSound.Knife.KnifeConcreteHit'
     HitSounds(3)=SoundGroup'BW_Core_WeaponSound.Knife.KnifeMetalHit'
     HitSounds(4)=SoundGroup'BW_Core_WeaponSound.Knife.KnifeWoodHit'
     HitSounds(5)=SoundGroup'BW_Core_WeaponSound.Knife.KnifeWoodHit'
     HitSounds(6)=SoundGroup'BW_Core_WeaponSound.Knife.KnifeConcreteHit'
     HitSounds(7)=SoundGroup'BW_Core_WeaponSound.Knife.KnifeConcreteHit'
     HitSounds(8)=SoundGroup'BW_Core_WeaponSound.Knife.KnifeConcreteHit'
     HitSounds(9)=SoundGroup'BW_Core_WeaponSound.NRP57.NRP57-Water'
     HitSounds(10)=SoundGroup'BW_Core_WeaponSound.Knife.KnifeConcreteHit'
