...
//=============================================================================
class BG_ScnBloodSlice extends BallisticEmitter
	placeable;
...
event PostBeginPlay()
{
	...
	F = FRand();
	if (F <= 0.5)
		Emitters[0].Texture=Texture'BallisticBloodPro.Decals.Slice1';
	else
		Emitters[0].Texture=Texture'BallisticBloodPro.Decals.Slice2';
}
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         Texture=Texture'BallisticBloodPro.Decals.Slice1'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=3.000000,Max=3.000000)
         StartVelocityRange=(Z=(Min=-0.500000,Max=-0.300000))
     End Object
     Emitters(0)=SpriteEmitter'BallisticProV55.BG_ScnBloodSlice.SpriteEmitter0'
