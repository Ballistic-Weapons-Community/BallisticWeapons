...
//=============================================================================
class BG_GibBloodTrailBot extends BallisticEmitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter27
         ...
         ColorMultiplierRange=(X=(Min=0.000000,Max=0.000000),Y=(Min=0.300000,Max=0.650000),Z=(Min=0.400000,Max=0.700000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'BallisticProV55.BG_GibBloodTrailBot.SpriteEmitter27'
