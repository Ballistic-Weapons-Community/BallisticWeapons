...
defaultproperties
{
     Swaps(0)=(Old=Class'XWeapons.ShieldGun',NewClassNames=("BallisticProV55.X3Knife","BallisticProV55.X4Knife","BallisticProV55.A909SkrithBlades","BallisticProV55.EKS43Katana"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(1)=(Old=Class'XWeapons.AssaultRifle',NewClassNames=("BallisticProV55.A42SkrithPistol","BallisticProV55.AM67Pistol","BallisticProV55.BOGPPistol","BallisticProV55.D49Revolver","BallisticProV55.M806Pistol","BallisticProV55.MD24Pistol","BallisticProV55.MRT6Shotgun","BallisticProV55.RS8Pistol","BallisticProV55.leMatRevolver"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(2)=(Old=Class'XWeapons.BioRifle',NewClassNames=("BallisticProV55.XK2SubMachinegun","BallisticProV55.Fifty9MachinePistol","BallisticProV55.XRS10SubmachineGun","BallisticProV55.XMK5SubMachinegun"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(3)=(Old=Class'XWeapons.ShockRifle',NewClassNames=("BallisticProV55.M50AssaultRifle","BallisticProV55.SARAssaultRifle","BallisticProV55.M46AssaultRifle"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(4)=(Old=Class'XWeapons.LinkGun',NewClassNames=("BallisticProV55.A73SkrithRifle","BallisticProV55.E23PlasmaRifle"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(5)=(Old=Class'XWeapons.Minigun',NewClassNames=("BallisticProV55.M353Machinegun","BallisticProV55.M925Machinegun","BallisticProV55.XMV850Minigun"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(6)=(Old=Class'XWeapons.FlakCannon',NewClassNames=("BallisticProV55.M763Shotgun","BallisticProV55.M290Shotgun","BallisticProV55.MRS138Shotgun","BallisticProV55.A500Reptile"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(7)=(Old=Class'XWeapons.RocketLauncher',NewClassNames=("BallisticProV55.G5Bazooka","BallisticProV55.RX22AFlamer","BallisticProV55.MACWeapon","BallisticProV55.MRocketLauncher"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(8)=(Old=Class'XWeapons.SniperRifle',NewClassNames=("BallisticProV55.M75Railgun"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(9)=(Old=Class'XWeapons.Painter',NewClassNames=("BallisticProV55.RSDarkStar","BallisticProV55.RSNovaStaff","BWBPAirstrikesPro.TargetDesignator"),NewClasses=,CurrentIndex=0,bSuper=True)
	 Swaps(10)=(Old=Class'XWeapons.Redeemer',NewClassNames=("BallisticProV55.HVCMk9LightningGun"),NewClasses=,CurrentIndex=0,bSuper=True)
	 Swaps(11)=(Old=Class'UTClassic.ClassicSniperRifle',NewClassNames=("BallisticProV55.R78Rifle","BallisticProV55.R9RangerRifle","BallisticProV55.MarlinRifle","BallisticProV55.SRS900Rifle"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(12)=(Old=Class'Onslaught.ONSAVRiL',NewClassNames=("BallisticProV55.G5Bazooka","BallisticProV55.MACWeapon"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(13)=(Old=Class'Onslaught.ONSGrenadeLauncher',NewClassNames=("BallisticProV55.NRP57Grenade"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(14)=(Old=Class'Onslaught.ONSMineLayer',NewClassNames=("BallisticProV55.BX5Mine"),NewClasses=,CurrentIndex=0,bSuper=False)
	 Swaps(15)=(Old=Class'OnslaughtFull.ONSPainter',NewClassNames=("BallisticProV55.R78Rifle"),NewClasses=,CurrentIndex=0,bSuper=True)
	 Swaps(16)=(Old=Class'XWeapons.SuperShockRifle',NewClassNames=("BallisticProV55.HVCMk9LightningGun"),NewClasses=,CurrentIndex=0,bSuper=True)
