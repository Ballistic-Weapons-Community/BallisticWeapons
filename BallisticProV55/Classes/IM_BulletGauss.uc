...
defaultproperties
{
     HitEffects(0)=Class'BallisticProV55.IE_BulletGauss'
     HitEffects(1)=Class'BallisticProV55.IE_BulletGauss'
     HitEffects(2)=Class'BallisticProV55.IE_BulletGauss'
     HitEffects(3)=Class'BallisticProV55.IE_BulletGauss'
     HitEffects(4)=Class'BallisticProV55.IE_BulletGauss'
     HitEffects(5)=Class'BallisticProV55.IE_BulletGauss'
     HitEffects(6)=Class'BallisticProV55.IE_BulletGauss'
     HitEffects(7)=Class'BallisticProV55.IE_BulletGauss'
     HitEffects(8)=Class'BallisticProV55.IE_BulletGauss'
