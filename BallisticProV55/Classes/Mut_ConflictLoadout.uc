...
defaultproperties
{
	 ...
	 ConflictWeapons(85)=(ClassName="BWBPOtherPackPro.BallisticShieldWeapon",bRed=True,bBlue=True)
	 ConflictWeapons(86)=(ClassName="BWBPOtherPackPro.FlameSword",bRed=True,bBlue=True)
	 ConflictWeapons(87)=(ClassName="BWBPOtherPackPro.JWJunkShieldWeapon",bRed=False,bBlue=False)
	 ConflictWeapons(88)=(ClassName="BWBPOtherPackPro.JWRiotShieldWeapon",bRed=False,bBlue=False)
	 ConflictWeapons(89)=(ClassName="BWBPOtherPackPro.MAG78Longsword",bRed=True,bBlue=True)
	 ConflictWeapons(90)=(ClassName="BWBPOtherPackPro.TrenchGun",bRed=True,bBlue=True)
	 ConflictWeapons(91)=(ClassName="BWBPOtherPackPro.XM20AutoLas",bRed=True,bBlue=True)
	 ...
	 ConflictWeapons(107)=(ClassName="BWBPOtherPackPro.ARShotgun",bRed=True,bBlue=True)
