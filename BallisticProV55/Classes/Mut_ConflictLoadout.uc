...
defaultproperties
{
	 ...
	 ConflictWeapons(58)=(ClassName="BWBPRecolorsPro.BulldogAssaultCannon",bRed=True,bBlue=True)
	 ConflictWeapons(59)=(ClassName="BWBPRecolorsPro.CYLOAssaultWeapon",bRed=True,bBlue=True)
	 ConflictWeapons(60)=(ClassName="BWBPRecolorsPro.CYLOUAW",bRed=True,bBlue=True)
	 ConflictWeapons(61)=(ClassName="BWBPRecolorsPro.ChaffGrenadeWeapon",bRed=True,bBlue=True)
	 ConflictWeapons(62)=(ClassName="BWBPRecolorsPro.CoachGun",bRed=True,bBlue=True)
	 ConflictWeapons(63)=(ClassName="BWBPRecolorsPro.DragonsToothSword",bRed=True,bBlue=True)
	 ConflictWeapons(64)=(ClassName="BWBPRecolorsPro.F2000AssaultRifle",bRed=True,bBlue=True)
	 ConflictWeapons(65)=(ClassName="BWBPRecolorsPro.FG50MachineGun",bRed=True,bBlue=True)
	 ConflictWeapons(66)=(ClassName="BWBPRecolorsPro.FLASHLauncher",bRed=False,bBlue=False)
	 ConflictWeapons(67)=(ClassName="BWBPRecolorsPro.G28Grenade",bRed=True,bBlue=True)
	 ConflictWeapons(68)=(ClassName="BWBPRecolorsPro.HVPCMk66PlasmaCannon",bRed=False,bBlue=False)
	 ConflictWeapons(69)=(ClassName="BWBPRecolorsPro.ICISStimpack",bRed=True,bBlue=True)
	 ConflictWeapons(70)=(ClassName="BWBPRecolorsPro.LAWLauncher",bRed=False,bBlue=False)
	 ConflictWeapons(71)=(ClassName="BWBPRecolorsPro.LK05Carbine",bRed=True,bBlue=True)
	 ConflictWeapons(72)=(ClassName="BWBPRecolorsPro.LS14Carbine",bRed=True,bBlue=True)
	 ConflictWeapons(73)=(ClassName="BWBPRecolorsPro.LonghornLauncher",bRed=True,bBlue=True)
	 ConflictWeapons(74)=(ClassName="BWBPRecolorsPro.M2020GaussDMR",bRed=True,bBlue=True)
	 ConflictWeapons(75)=(ClassName="BWBPRecolorsPro.MARSAssaultRifle",bRed=True,bBlue=True)
	 ConflictWeapons(76)=(ClassName="BWBPRecolorsPro.MGLauncher",bRed=False,bBlue=False)
	 ConflictWeapons(77)=(ClassName="BWBPRecolorsPro.MK781Shotgun",bRed=True,bBlue=True)
	 ConflictWeapons(78)=(ClassName="BWBPRecolorsPro.MRDRMachinePistol",bRed=True,bBlue=True)
	 ConflictWeapons(79)=(ClassName="BWBPRecolorsPro.PS9mPistol",bRed=True,bBlue=True)
	 ConflictWeapons(80)=(ClassName="BWBPRecolorsPro.SK410Shotgun",bRed=True,bBlue=True)
	 ConflictWeapons(81)=(ClassName="BWBPRecolorsPro.SKASShotgun",bRed=False,bBlue=False)
	 ConflictWeapons(82)=(ClassName="BWBPRecolorsPro.X82Rifle",bRed=True,bBlue=True)
	 ConflictWeapons(83)=(ClassName="BWBPRecolorsPro.X8Knife",bRed=True,bBlue=True)
	 ConflictWeapons(84)=(ClassName="BWBPRecolorsPro.XM84Flashbang",bRed=True,bBlue=True)
	 ConflictWeapons(85)=(ClassName="BWBPSomeOtherPack.BallisticShieldWeapon",bRed=True,bBlue=True)
	 ConflictWeapons(86)=(ClassName="BWBPSomeOtherPack.FlameSword",bRed=True,bBlue=True)
	 ConflictWeapons(87)=(ClassName="BWBPSomeOtherPack.JWJunkShieldWeapon",bRed=False,bBlue=False)
	 ConflictWeapons(88)=(ClassName="BWBPSomeOtherPack.JWRiotShieldWeapon",bRed=False,bBlue=False)
	 ConflictWeapons(89)=(ClassName="BWBPSomeOtherPack.MAG78Longsword",bRed=True,bBlue=True)
	 ConflictWeapons(90)=(ClassName="BWBPSomeOtherPack.TrenchGun",bRed=True,bBlue=True)
	 ConflictWeapons(91)=(ClassName="BWBPSomeOtherPack.XM20AutoLas",bRed=True,bBlue=True)
	 ConflictWeapons(92)=(ClassName="BWBPOtherPackPro.AkeronLauncher",bRed=True,bBlue=True)
	 ConflictWeapons(93)=(ClassName="BWBPOtherPackPro.BX85Crossbow",bRed=True,bBlue=True)
	 ConflictWeapons(94)=(ClassName="BWBPOtherPackPro.CX61AssaultRifle",bRed=True,bBlue=True)
	 ConflictWeapons(95)=(ClassName="BWBPOtherPackPro.CX85AssaultWeapon",bRed=True,bBlue=True)
	 ConflictWeapons(96)=(ClassName="BWBPOtherPackPro.DefibFists",bRed=True,bBlue=True)
	 ConflictWeapons(97)=(ClassName="BWBPOtherPackPro.M575Machinegun",bRed=True,bBlue=False)
	 ConflictWeapons(98)=(ClassName="BWBPOtherPackPro.PD97Bloodhound",bRed=True,bBlue=True)
	 ConflictWeapons(99)=(ClassName="BWBPOtherPackPro.ProtonStreamer",bRed=True,bBlue=True)
	 ConflictWeapons(100)=(ClassName="BWBPOtherPackPro.R9A1RangerRifle",bRed=True,bBlue=True)
	 ConflictWeapons(101)=(ClassName="BWBPOtherPackPro.Raygun",bRed=True,bBlue=True)
	 ConflictWeapons(102)=(ClassName="BWBPOtherPackPro.WrenchWarpDevice",bRed=True,bBlue=True)
	 ConflictWeapons(103)=(ClassName="BWBPOtherPackPro.XOXOStaff",bRed=True,bBlue=True)
	 ConflictWeapons(104)=(ClassName="BWBPOtherPackPro.Z250Minigun",bRed=True,bBlue=True)
	 ...
	 ConflictWeapons(107)=(ClassName="BallisticJiffyPack.ARShotgun",bRed=True,bBlue=True)
