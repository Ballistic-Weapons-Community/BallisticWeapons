//=============================================================================
// BG_ScnBloodSliceAlien.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2007 RuneStorm. All Rights Reserved.
//=============================================================================
class BG_ScnBloodSliceAlien extends BallisticEmitter
	placeable;
...
event PostBeginPlay()
{
	...
	F = FRand();
	if (F <= 0.5)
		Emitters[0].Texture=Texture'BallisticBloodPro.Alien.Alien-Slice1';
	else
		Emitters[0].Texture=Texture'BallisticBloodPro.Alien.Alien-Slice2';
}
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         Texture=Texture'BallisticBloodPro.Alien.Alien-Slice1'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=3.000000,Max=3.000000)
         StartVelocityRange=(Z=(Min=-0.500000,Max=-0.300000))
     End Object
     Emitters(0)=SpriteEmitter'BallisticProV55.BG_ScnBloodSliceAlien.SpriteEmitter0'
