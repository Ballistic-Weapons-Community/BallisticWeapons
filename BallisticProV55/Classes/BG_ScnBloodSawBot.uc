...
//=============================================================================
class BG_ScnBloodSawBot extends BallisticEmitter
	placeable;
...
event PostBeginPlay()
{
	...
	F = FRand();
	if (F <= 0.333)
		Emitters[0].Texture=Texture'BallisticBloodPro.Bot.Bot-Cut1';
	else if (F <= 0.666)
		Emitters[0].Texture=Texture'BallisticBloodPro.Bot.Bot-Cut2';
	else
		Emitters[0].Texture=Texture'BallisticBloodPro.Bot.Bot-Cut3';
}
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         Texture=Texture'BallisticBloodPro.Bot.Bot-Cut1'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=3.000000,Max=3.000000)
         StartVelocityRange=(Z=(Min=-0.500000,Max=-0.300000))
     End Object
     Emitters(0)=SpriteEmitter'BallisticProV55.BG_ScnBloodSawBot.SpriteEmitter0'
