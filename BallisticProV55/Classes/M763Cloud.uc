...
// M763Cloud.
//
// A cloud of gas from the m6763363636 grenade. The controller wil damage the actors this is touching
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class M763Cloud extends BallisticEmitter
	placeable;

var   AvoidMarker		Fear;			// Da phear spauwt...
var   M763CloudControl	MyControl;		// The cloud controlling actor
...
simulated function PostBeginPlay()
{
	...
	MyControl = M763CloudControl(Owner);
...
defaultproperties
{
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=200,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=0.000000,Max=0.000000),Z=(Min=0.200000,Max=0.200000))
         Opacity=0.490000
     ...
     End Object
     Emitters(0)=SpriteEmitter'BallisticProV55.M763Cloud.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorScale(0)=(Color=(B=200,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=200,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=0.000000,Max=0.200000),Z=(Min=0.000000,Max=0.200000))
         Opacity=0.580000
     ...
     End Object
     Emitters(1)=SpriteEmitter'BallisticProV55.M763Cloud.SpriteEmitter0'
