...
//=============================================================================
class HVCMk9_SideArc extends BallisticEmitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'BallisticProV55.HVCMk9_SideArc.SpriteEmitter1'
     ...
     End Object
     Emitters(1)=BeamEmitter'BallisticProV55.HVCMk9_SideArc.BeamEmitter2'

     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         UniformSize=True
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=0.100000,Max=0.100000),Y=(Min=0.200000,Max=0.200000))
         CoordinateSystem=PTCS_Relative
         MaxParticles=1
         ...
         LifetimeRange=(Min=0.200000,Max=0.200000)
     End Object
     Emitters(2)=SpriteEmitter'BallisticProV55.HVCMk9_SideArc.SpriteEmitter2'
