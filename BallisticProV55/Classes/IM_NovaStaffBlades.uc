...
defaultproperties
{
     ...
     HitSounds(0)=SoundGroup'BW_Core_WeaponSound.NovaStaff.Nova-Concrete'
     HitSounds(1)=SoundGroup'BW_Core_WeaponSound.NovaStaff.Nova-Concrete'
     HitSounds(2)=SoundGroup'BW_Core_WeaponSound.NovaStaff.Nova-Dirt'
     HitSounds(3)=SoundGroup'BW_Core_WeaponSound.NovaStaff.Nova-Metal'
     HitSounds(4)=SoundGroup'BW_Core_WeaponSound.NovaStaff.Nova-Wood'
     HitSounds(5)=SoundGroup'BW_Core_WeaponSound.NovaStaff.Nova-Dirt'
     HitSounds(6)=SoundGroup'BW_Core_WeaponSound.NovaStaff.Nova-Flesh'
     HitSounds(7)=SoundGroup'BW_Core_WeaponSound.NovaStaff.Nova-Dirt'
     HitSounds(8)=SoundGroup'BW_Core_WeaponSound.NovaStaff.Nova-Dirt'
     HitSounds(9)=SoundGroup'BW_Core_WeaponSound.NRP57.NRP57-Water'
     HitSounds(10)=SoundGroup'BW_Core_WeaponSound.NovaStaff.Nova-Concrete'
