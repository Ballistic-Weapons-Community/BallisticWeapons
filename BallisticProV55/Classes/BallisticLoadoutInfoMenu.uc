...
//=============================================================================
class BallisticLoadoutInfoMenu extends UT2K4GUIPage;
...
var BallisticLoadOutMenu LoadoutMenu;
...
function LoadWeapons(BallisticLoadOutMenu Source)
{
	local int i;
	...
	for(i=0;i<Source.COI.GetItemsLength();i++)
	{
		if (Source.COI.GetItem(i).ItemName != "")
		{
	...
	l_StatTimeMy.Caption =		StatTimeCaption		$ LoadoutMenu.COI.ElapsedTime;
	...
	l_StatSniperEffMy.Caption =		StatSnprEffCaption	$ LoadoutMenu.COI.MyLoadoutInfo.SniperEff;
	l_StatShotgunEffMy.Caption =	StatStgnEffCaption	$ LoadoutMenu.COI.MyLoadoutInfo.ShotgunEff;
	l_StatHazardEffMy.Caption =		StatHzrdEffCaption	$ LoadoutMenu.COI.MyLoadoutInfo.HazardEff;
	l_StatDamageRateMy.Caption =	StatDmgRtCaption	$ LoadoutMenu.COI.MyLoadoutInfo.DamageRate;
...
//	if (LoadoutMenu.COI.GetItem(i).Requirements.MatchTime > PlayerOwner().level.Game.GameReplicationInfo.ElapsedTime)
	if (LoadoutMenu.COI.GetItem(i).Requirements.MatchTime > LoadoutMenu.COI.ElapsedTime)
		l_StatTime.TextColor = Red;
	else
		l_StatTime.TextColor = Green;
	l_StatTime.Caption =		StatTimeCaption		$ LoadoutMenu.COI.GetItem(i).Requirements.MatchTime;

	if (LoadoutMenu.COI.GetItem(i).Requirements.Frags > PlayerOwner().PlayerReplicationInfo.Score)
		l_StatFrags.TextColor = Red;
	else
		l_StatFrags.TextColor = Green;
	l_StatFrags.Caption =		StatFragsCaption	$ LoadoutMenu.COI.GetItem(i).Requirements.Frags;

	if (PlayerOwner().PlayerReplicationInfo.Deaths == 0)
	{
		if (LoadoutMenu.COI.GetItem(i).Requirements.Efficiency > PlayerOwner().PlayerReplicationInfo.Score / 0.1)
	...
	{
		if (LoadoutMenu.COI.GetItem(i).Requirements.Efficiency > PlayerOwner().PlayerReplicationInfo.Score / PlayerOwner().PlayerReplicationInfo.Deaths)
			l_StatEfficiency.TextColor = Red;
		else
			l_StatEfficiency.TextColor = Green;
	}
	if (LoadoutMenu.COI.GetItem(i).Requirements.SniperEff > LoadoutMenu.COI.MyLoadoutInfo.SniperEff)
		l_StatSniperEff.TextColor = Red;
	else
		l_StatSniperEff.TextColor = Green;

	if (LoadoutMenu.COI.GetItem(i).Requirements.ShotgunEff > LoadoutMenu.COI.MyLoadoutInfo.ShotgunEff)
		l_StatShotgunEff.TextColor = Red;
	else
		l_StatShotgunEff.TextColor = Green;

	if (LoadoutMenu.COI.GetItem(i).Requirements.HazardEff > LoadoutMenu.COI.MyLoadoutInfo.HazardEff)
		l_StatHazardEff.TextColor = Red;
	else
		l_StatHazardEff.TextColor = Green;

	l_StatEfficiency.Caption =		StatEffCaption	$ LoadoutMenu.COI.GetItem(i).Requirements.Efficiency;
	l_StatSniperEff.Caption =		StatSnprEffCaption	$ LoadoutMenu.COI.GetItem(i).Requirements.SniperEff;
	l_StatShotgunEff.Caption =		StatStgnEffCaption	$ LoadoutMenu.COI.GetItem(i).Requirements.ShotgunEff;
	l_StatHazardEff.Caption =		StatHzrdEffCaption	$ LoadoutMenu.COI.GetItem(i).Requirements.HazardEff;

	if (LoadoutMenu.COI.GetItem(i).Requirements.DamageRate > LoadoutMenu.COI.MyLoadoutInfo.DamageRate)
		l_StatDamageRate.TextColor = Red;
	else
		l_StatDamageRate.TextColor = Green;
	l_StatDamageRate.Caption =		StatDmgRtCaption	$ LoadoutMenu.COI.GetItem(i).Requirements.DamageRate;
...
function bool GetItemInfo(int Index, out string ItemCap, out Material ItemImage, out string ItemClassName, optional out IntBox ImageCoords)
{
	...
	ItemCName = LoadoutMenu.COI.GetItem(Index).ItemName;
	if (ItemCName == "")
		return false;
...
defaultproperties
{
     ...
     End Object
     MyBack=GUIImage'BallisticProV55.BallisticLoadoutInfoMenu.BackImage'
     ...
     End Object
     Box_WeaponList=GUIImage'BallisticProV55.BallisticLoadoutInfoMenu.ImageBoxWeapons'
     ...
     Begin Object Class=GUIImage Name=ImageBox_WeaponIcon
         ...
         RenderWeight=0.002000
     End Object
     Box_WeaponIcon=GUIImage'BallisticProV55.BallisticLoadoutInfoMenu.ImageBox_WeaponIcon'
     ...
     End Object
     IconBack=GUIImage'BallisticProV55.BallisticLoadoutInfoMenu.IconBackImage'
     ...
     End Object
     WeaponIcon=GUIImage'BallisticProV55.BallisticLoadoutInfoMenu.WeaponIconImage'
     ...
     Begin Object Class=GUIButton Name=DoneButton
         ...
         WinWidth=0.200000
         TabOrder=0
         OnClick=BallisticLoadoutInfoMenu.InternalOnClick
         OnKeyEvent=DoneButton.InternalOnKeyEvent
     End Object
     bDone=GUIButton'BallisticProV55.BallisticLoadoutInfoMenu.DoneButton'
     ...
     Begin Object Class=GUIHeader Name=DaBeegHeader
         ...
         WinHeight=0.031250
     End Object
     MyHeader=GUIHeader'BallisticProV55.BallisticLoadoutInfoMenu.DaBeegHeader'
     ...
     Begin Object Class=GUILabel Name=l_StatTimeLabel
         ...
         WinHeight=0.040000
     End Object
     l_StatTime=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatTimeLabel'
     ...
     Begin Object Class=GUILabel Name=l_StatFragsLabel
         ...
         WinHeight=0.040000
     End Object
     l_StatFrags=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatFragsLabel'
     ...
     Begin Object Class=GUILabel Name=l_StatEfficiencyLabel
         ...
         WinHeight=0.040000
     End Object
     l_StatEfficiency=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatEfficiencyLabel'
     ...
     Begin Object Class=GUILabel Name=l_StatDamageRateLabel
         ...
         WinHeight=0.040000
     End Object
     l_StatDamageRate=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatDamageRateLabel'
     ...
     Begin Object Class=GUILabel Name=l_StatSniperEffLabel
         ...
         WinHeight=0.040000
     End Object
     l_StatSniperEff=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatSniperEffLabel'
     ...
     Begin Object Class=GUILabel Name=l_StatShotgunEffLabel
         ...
         WinHeight=0.040000
     End Object
     l_StatShotgunEff=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatShotgunEffLabel'
     ...
     Begin Object Class=GUILabel Name=l_StatHazardEffLabel
         ...
         WinHeight=0.040000
     End Object
     l_StatHazardEff=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatHazardEffLabel'
     ...
     Begin Object Class=GUILabel Name=l_StatHeadingLabel
         ...
         WinHeight=0.040000
     End Object
     l_StatHeading=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatHeadingLabel'
     ...
     Begin Object Class=GUILabel Name=l_StatTimeLabelMy
         ...
         WinHeight=0.040000
     End Object
     l_StatTimeMy=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatTimeLabelMy'
     ...
     Begin Object Class=GUILabel Name=l_StatFragsLabelMy
         ...
         WinHeight=0.040000
     End Object
     l_StatFragsMy=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatFragsLabelMy'
     ...
     Begin Object Class=GUILabel Name=l_StatEfficiencyLabelMy
         ...
         WinHeight=0.040000
     End Object
     l_StatEfficiencyMy=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatEfficiencyLabelMy'
     ...
     Begin Object Class=GUILabel Name=l_StatDamageRateLabelMy
         ...
         WinHeight=0.040000
     End Object
     l_StatDamageRateMy=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatDamageRateLabelMy'
     ...
     Begin Object Class=GUILabel Name=l_StatSniperEffLabelMy
         ...
         WinHeight=0.040000
     End Object
     l_StatSniperEffMy=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatSniperEffLabelMy'
     ...
     Begin Object Class=GUILabel Name=l_StatShotgunEffLabelMy
         ...
         WinHeight=0.040000
     End Object
     l_StatShotgunEffMy=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatShotgunEffLabelMy'
     ...
     Begin Object Class=GUILabel Name=l_StatHazardEffLabelMy
         ...
         WinHeight=0.040000
     End Object
     l_StatHazardEffMy=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatHazardEffLabelMy'
     ...
     Begin Object Class=GUILabel Name=l_StatHeadingLabelMy
         ...
         WinHeight=0.040000
     End Object
     l_StatHeadingMy=GUILabel'BallisticProV55.BallisticLoadoutInfoMenu.l_StatHeadingLabelMy'
     ...
     Begin Object Class=GUIListBox Name=WeaponList
         ...
         TabOrder=1
     End Object
     lb_Weapons=GUIListBox'BallisticProV55.BallisticLoadoutInfoMenu.WeaponList'
     ...
     bRenderWorld=True
     bAllowedAsLast=True
     OnClose=BallisticLoadoutInfoMenu.InternalOnClose
     OnKeyEvent=BallisticLoadoutInfoMenu.InternalOnKeyEvent
}
