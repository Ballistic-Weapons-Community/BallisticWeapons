...
defaultproperties
{
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBP_JWC_Pro.IM_JunkNeonBroken'
         HookStopFactor=1.200000
         HookPullForce=80.000000
         Damage=(head=82,Limb=17,Misc=32)
         KickForce=5000
         DamageType=Class'BWBP_JWC_Pro.DTJunkNeonLightStab'
         RefireTime=0.300000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBP_JWC_Pro.JO_NeonLightBroken.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         KickForce=10000
         DamageType=Class'BWBP_JWC_Pro.DTJunkNeonLightStabSec'
         RefireTime=0.800000
         AnimRate=1.250000
         Sound=(Sound=SoundGroup'BWBP_JW_Sound.Pipe.Pipe-Swing')
         Anims(0)="StabAttack"
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBP_JWC_Pro.JO_NeonLightBroken.JunkFireInfo1'
     ...
     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         ...
         ExplodeManager=Class'BWBP_JWC_Pro.IM_JunkNeonLightBreak'
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBP_JWC_Pro.JO_NeonLightBroken.JunkThrowFireInfo0'
