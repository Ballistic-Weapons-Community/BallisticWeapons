...
defaultproperties
{
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBP_JWC_Pro.IM_JunkWoodenStick'
         HookStopFactor=0.800000
         Damage=(head=92,Limb=20,Misc=42)
         KickForce=12000
         DamageType=Class'BWBP_JWC_Pro.DTJunkWoodenStick'
         RefireTime=0.750000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBP_JWC_Pro.JO_WoodenStick.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBP_JWC_Pro.JO_WoodenStick.JunkFireInfo1'
