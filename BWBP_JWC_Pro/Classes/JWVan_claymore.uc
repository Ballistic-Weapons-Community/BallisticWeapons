...
defaultproperties
{
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBP_JWC_Pro.IM_claymore'
         HookStopFactor=1.000000
         Damage=(head=165,Limb=35,Misc=50)
         KickForce=12000
         DamageType=Class'BWBP_JWC_Pro.DTclaymore'
         RefireTime=0.650000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBP_JWC_Pro.JWVan_claymore.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Early
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBP_JWC_Pro.JWVan_claymore.JunkFireInfo1'
