...
defaultproperties
{
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBP_JWC_Pro.IM_ACGuitar'
         HookStopFactor=1.000000
         Damage=(head=110,Limb=25,Misc=50)
         KickForce=12000
         DamageType=Class'BWBP_JWC_Pro.DTacguitar'
         RefireTime=0.800000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBP_JWC_Pro.JWVan_acguitar.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBP_JWC_Pro.JWVan_acguitar.JunkFireInfo1'
