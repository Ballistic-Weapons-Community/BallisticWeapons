...
defaultproperties
{
     ...
     BlockRate=0.700000
     rating=55.000000
     ShieldPropClass=Class'BWBP_JWC_Pro.JWVan_sh_fenderProp'
     AttachOffset=(X=1.000000,Y=0.000000,Z=1.000000)
     AttachPivot=(Pitch=1024,Yaw=-16000,Roll=14000)
     Health=525
     HurtThreshold=40
     MaxProtection=225
     PickupClass=Class'BWBP_JWC_Pro.JWVan_sh_fenderPickup'
     PlayerViewOffset=(X=-10.000000,Y=16.000000)
     AttachmentClass=Class'BWBP_JWC_Pro.JWVan_sh_fenderAttachment'
     ItemName="Bumper"
}
