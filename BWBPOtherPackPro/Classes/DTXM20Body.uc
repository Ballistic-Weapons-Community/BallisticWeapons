...
//=============================================================================
class DTXM20Body extends DT_BWMiscDamage;

defaultproperties
{
     DeathStrings(0)="%o melted away in a brilliant storm of %k's Auto Las."
     ...
     WeaponClass=Class'BWBPOtherPackPro.XM20AutoLas'
     DeathString="%o melted away in a brilliant storm of %k's Auto Las."
