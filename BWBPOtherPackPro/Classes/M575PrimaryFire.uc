...
defaultproperties
{
     ...
     DamageType=Class'BWBPOtherPackPro.DTM575MG'
     DamageTypeHead=Class'BWBPOtherPackPro.DTM575MGHead'
     DamageTypeArm=Class'BWBPOtherPackPro.DTM575MG'
     KickForce=2000
     PenetrateForce=150
     bPenetrate=True
     DryFireSound=(Sound=Sound'BW_Core_WeaponSound.Misc.DryRifle',Volume=0.700000)
     bCockAfterEmpty=True
     MuzzleFlashClass=Class'BWBPOtherPackPro.M575FlashEmitter'
	 FlashBone="Muzzle"
     ...
     FireEndAnim=
     FireRate=0.082000
     AmmoClass=Class'BWBPOtherPackPro.Ammo_556mmBelt'
