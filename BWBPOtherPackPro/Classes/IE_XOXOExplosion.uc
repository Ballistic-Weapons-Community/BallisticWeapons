class IE_XOXOExplosion extends BallisticEmitter;

defaultproperties
{
     Begin Object Class=SpriteEmitter Name=XOXOExplodeSmoke
         UseCollision=True
         UseColorScale=True
         FadeOut=True
         ...
         ColorScale(1)=(RelativeTime=0.032143,Color=(B=192,G=136,R=255,A=255))
         ColorScale(2)=(RelativeTime=0.114286,Color=(B=150,G=107,R=255,A=255))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=139,R=255,A=255))
         Opacity=0.400000
     ...
     End Object
     Emitters(0)=SpriteEmitter'BWBPOtherPackPro.IE_XOXOExplosion.XOXOExplodeSmoke'

     Begin Object Class=SpriteEmitter Name=XOXOExplodeShockwave
     ...
     End Object
     Emitters(1)=SpriteEmitter'BWBPOtherPackPro.IE_XOXOExplosion.XOXOExplodeShockwave'

     Begin Object Class=SpriteEmitter Name=XOXOExplodeShockwave2
         FadeOut=True
         RespawnDeadParticles=False
         UseSizeScale=True
         UseRegularSizeScale=False
         ...
         LifetimeRange=(Min=0.500000,Max=0.500000)
     End Object
     Emitters(2)=SpriteEmitter'BWBPOtherPackPro.IE_XOXOExplosion.XOXOExplodeShockwave2'

     Begin Object Class=SpriteEmitter Name=XOXOExplodeOEffect
         UseCollision=True
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(3)=SpriteEmitter'BWBPOtherPackPro.IE_XOXOExplosion.XOXOExplodeOEffect'

     Begin Object Class=SpriteEmitter Name=XOXOExplodeHotFlare
         FadeOut=True
         RespawnDeadParticles=False
         SpinParticles=True
         UseSizeScale=True
         ...
         LifetimeRange=(Min=0.500000,Max=0.500000)
     End Object
     Emitters(4)=SpriteEmitter'BWBPOtherPackPro.IE_XOXOExplosion.XOXOExplodeHotFlare'

     Begin Object Class=SpriteEmitter Name=XOXOExplodeXEffect
         UseCollision=True
         UseMaxCollisions=True
         FadeOut=True
         RespawnDeadParticles=False
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(5)=SpriteEmitter'BWBPOtherPackPro.IE_XOXOExplosion.XOXOExplodeXEffect'

     Begin Object Class=SpriteEmitter Name=XOXOExplodeBlastSpray
         FadeOut=True
         FadeIn=True
         RespawnDeadParticles=False
         SpinParticles=True
     ...
     End Object
     Emitters(6)=SpriteEmitter'BWBPOtherPackPro.IE_XOXOExplosion.XOXOExplodeBlastSpray'

     Begin Object Class=SparkEmitter Name=XOXOExplodeBangSparks
         ...
         LifetimeRange=(Min=2.000000,Max=2.000000)
     End Object
     Emitters(7)=SparkEmitter'BWBPOtherPackPro.IE_XOXOExplosion.XOXOExplodeBangSparks'
