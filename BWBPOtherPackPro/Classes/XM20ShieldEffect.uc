...
function SetRedSkin()
{
	MatDam = FinalBlend'BWBP_SKC_TexExp.AIMS.AIMSShield3rdFB';
	MatShot = FinalBlend'BWBP_SKC_TexExp.AIMS.AIMSShield3rdFB';
...
defaultproperties
{
     ...
     MatShot=Shader'BWBP_SKC_TexExp.PUMA.PUMA-ShieldSD'
     MatDam=Shader'BWBP_SKC_TexExp.PUMA.PUMA-ShieldSD'
