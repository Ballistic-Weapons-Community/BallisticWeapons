...
simulated function BringUp(optional Weapon PrevWeapon)
{
	...
	{
		Laser = Spawn(class'BWBPOtherPackPro.LaserActor_XM20BRed');
	}
...
{
	if (LaserDot == None)
		LaserDot = Spawn(class'BWBPOtherPackPro.IE_XM20BImpact',,,Loc);
}
...
defaultproperties
{
     ...
     PickupClass=Class'BWBPOtherPackPro.XM20BPickup'
