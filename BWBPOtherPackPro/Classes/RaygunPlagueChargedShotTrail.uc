class RaygunPlagueChargedShotTrail extends BallisticEmitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter7
         ...
         ColorScale(1)=(RelativeTime=0.485714,Color=(G=159,R=139,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(G=230,R=196,A=255))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=73,G=182,R=166,A=255))
         ColorScale(4)=(RelativeTime=1.000000,Color=(B=17,G=147,R=43))
         Opacity=0.300000
     ...
     End Object
     Emitters(0)=SpriteEmitter'BWBPOtherPackPro.RaygunPlagueChargedShotTrail.SpriteEmitter7'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter8
         ...
         ColorMultiplierRange=(X=(Min=0.000000,Max=0.000000),Y=(Min=0.000000),Z=(Min=0.000000,Max=0.000000))
         Opacity=0.070000
         ...
         LifetimeRange=(Min=0.500000,Max=0.500000)
     End Object
     Emitters(1)=SpriteEmitter'BWBPOtherPackPro.RaygunPlagueChargedShotTrail.SpriteEmitter8'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter10
         ...
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=215,G=192,R=68,A=255))
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(2)=SpriteEmitter'BWBPOtherPackPro.RaygunPlagueChargedShotTrail.SpriteEmitter10'
     ...
     End Object
     Emitters(3)=SpriteEmitter'BWBPOtherPackPro.RaygunPlagueChargedShotTrail.SpriteEmitter11'
     ...
     End Object
     Emitters(4)=SpriteEmitter'BWBPOtherPackPro.RaygunPlagueChargedShotTrail.SpriteEmitter12'
     ...
     End Object
     Emitters(5)=SpriteEmitter'BWBPOtherPackPro.RaygunPlagueChargedShotTrail.SpriteEmitter13'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter14
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(6)=SpriteEmitter'BWBPOtherPackPro.RaygunPlagueChargedShotTrail.SpriteEmitter14'
     ...
     Begin Object Class=TrailEmitter Name=TrailEmitter0
         ...
         AutomaticInitialSpawning=False
         ColorMultiplierRange=(X=(Min=0.400000,Max=0.400000),Y=(Min=0.600000,Max=0.600000),Z=(Min=0.000000,Max=0.000000))
         Opacity=0.150000
         MaxParticles=1
     ...
     End Object
     Emitters(7)=TrailEmitter'BWBPOtherPackPro.RaygunPlagueChargedShotTrail.TrailEmitter0'
